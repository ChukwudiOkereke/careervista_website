...
var Conditions = (function(B, uA) {
  return {
    IE: B.IE && B.IE < 8 && !/(Windows XP)/.test(uA),
...
Extend(Pushup, {
  ...
  build: function() {
    $.colorbox({ href: "/sites/all/modules/custom/emacustomizations/pushup/popup.php?link="+this.updateLinks[Pushup._updateBrowser || 'IE'], opacity: 0.5 });
    /*
